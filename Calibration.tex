...
\begin{tabular}{cc}
	...
	\includegraphics[width=0.4\textwidth]{IMGs/1.-Calibrado/Dura_HR_H.png} & \includegraphics[width=0.4\textwidth]{Dura_LR_H.png} \\ 
	\\
	Women transmission probability of HPV low risk & Men transmission probability of HPV high risk \\
	\includegraphics[width=0.4\textwidth]{IMGs/1.-Calibrado/Ctg_M_LR.png} & \includegraphics[width=0.4\textwidth]{Ctg_H_HR.png}  
\end{tabular}
